...
model_urls = {
    ...
    'hrnet48_cityscapes': r'https://optgaw.dm.files.1drv.com/y4mWNpya38VArcDInoPaL7GfPMgcop92G6YRkabO1QTSWkCbo7djk8BFZ6LK_KHHIYE8wqeSAChU58NVFOZEvqFaoz392OgcyBrq_f8XGkusQep_oQsuQ7DPQCUrdLwyze_NlsyDGWot0L9agkQ-M_SfNr10ETlCF5R7BdKDZdupmcMXZc-IE3Ysw1bVHdOH4l-XEbEKFAi6ivPUbeqlYkRMQ',
...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self,
        ...
        last_inp_channels = np.uint16(np.sum(pre_stage_channels))
...
def _hrnet(arch, pretrained, progress, **kwargs):
    ...
    if pretrained:
        model_url = model_urls["hrnet48_imagenet"]
        state_dict = load_state_dict_from_url(model_url,progress=progress,model_dir="./",file_name="test2.pth")
