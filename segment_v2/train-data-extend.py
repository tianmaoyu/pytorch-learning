...
from data import ExtendWaterDataset
import logging
...
def merge_datasets(dataset_list):
    ...
    new_dataset = ExtendWaterDataset(dataset_list[0].path)
...
dataset1 = ExtendWaterDataset(f"E:\语义分割\water_v1\water_v1")
dataset2 = ExtendWaterDataset(f"E:\语义分割\water_v2\water_v2")
dataset3 = ExtendWaterDataset(f"D:\语义分割\水体标注\project-2-at-2024-09-06-17-48-376b4f93")
